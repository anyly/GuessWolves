...
public class Game2 {
    ...
    public Game2(int no, List<String> setting) {
        this.no = no;
...
//                            if (seat==3)poker = "狼人";
     ...
     * @param target
     */
    public void asRobber(Player player, Integer target) {
        robber(player, target);
    }
     ...
     * @param targets
     */
    public void asTroubleMarker(Player player, Integer[] targets) {
        troubleMarker(player, targets);
    }
     ...
     * @param target
     */
    public void asDrunk(Player player, Integer target) {
        drunk(player, target);
    }
